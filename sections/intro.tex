...
\begin{frame}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \only<2>{\includegraphics[width=0.5\textwidth]{imgs/kaye}}%
        \only<3->{\includegraphics[width=0.5\textwidth]{imgs/kaye-waitrose}}%

        \only<1->{\visible<6->{\emph{`Wow, this guy seems pretty groovy'}}}
    \end{minipage}
    \begin{minipage}{0.49\textwidth}
        \centering
        \only<2-4>{\visible<4>{\includegraphics[width=0.5\textwidth]{imgs/ghica}}}%
        \only<5->{\includegraphics[width=0.5\textwidth]{imgs/ghica-ocaml}}%
...
\begin{frame}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \only<1>{\includegraphics[width=0.5\textwidth]{imgs/kaye-grad}}%
        \only<2->{\includegraphics[width=0.5\textwidth]{imgs/kaye-phd}}%
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \visible<3->{\includegraphics[width=0.5\textwidth]{imgs/ghica}}
...
\begin{frame}
    ...
    \(
        \visible<2->{\includegraphics[width=0.2\textwidth]{imgs/ghica}}
        \visible<3->{\raisebox{3em}{ \(+\) }\includegraphics[width=0.2\textwidth]{imgs/zanasi}}
        \visible<4->{\raisebox{3em}{ \(=\) } \includegraphics[width=0.2\textwidth]{imgs/money}}
    \)

    \vspace{1em}

    \(
        \visible<5->{\includegraphics[width=0.2\textwidth]{imgs/ghica}}
        \visible<6->{\raisebox{3em}{ \(+\) }\includegraphics[width=0.2\textwidth]{imgs/money}}
        \visible<7->{\raisebox{3em}{ \(=\) } \includegraphics[width=0.2\textwidth]{imgs/sprunger}}
    \)
