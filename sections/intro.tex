...
\begin{frame}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \iftoggle{static}{}{\only<2>{\includegraphics[width=0.5\textwidth]{imgs/kaye}}}%
        \iftoggle{static}{\includegraphics[width=0.5\textwidth]{imgs/kaye-waitrose}}{\only<3->{\includegraphics[width=0.5\textwidth]{imgs/kaye-waitrose}}}%

        \only<1->{\visible<\iftoggle{static}{1}{6-}>{\emph{`Wow, this guy seems pretty groovy'}}}
    \end{minipage}
    \begin{minipage}{0.49\textwidth}
        \centering
        \iftoggle{static}{}{\only<2-4>{\visible<4>{\includegraphics[width=0.5\textwidth]{imgs/ghica}}}}%
        \iftoggle{static}{\includegraphics[width=0.5\textwidth]{imgs/ghica-ocaml}}{\only<5->{\includegraphics[width=0.5\textwidth]{imgs/ghica-ocaml}}}%
...
\begin{frame}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \iftoggle{static}{}{\only<1>{\includegraphics[width=0.5\textwidth]{imgs/kaye-grad}}}%
        \iftoggle{static}{\includegraphics[width=0.5\textwidth]{imgs/kaye-phd}}{\only<2->{\includegraphics[width=0.5\textwidth]{imgs/kaye-phd}}}%
...
\begin{frame}
    ...
    \(
        \visible<\iftoggle{static}{1}{2-}>{\includegraphics[width=0.2\textwidth]{imgs/ghica}}
        \visible<\iftoggle{static}{1}{3-}>{\raisebox{3em}{ \(+\) }\includegraphics[width=0.2\textwidth]{imgs/zanasi}}
        \visible<\iftoggle{static}{1}{4-}>{\raisebox{3em}{ \(=\) } \includegraphics[width=0.2\textwidth]{imgs/money}}
    \)

    \vspace{1em}

    \(
        \visible<\iftoggle{static}{1}{5-}>{\includegraphics[width=0.2\textwidth]{imgs/ghica}}
        \visible<\iftoggle{static}{1}{6-}>{\raisebox{3em}{ \(+\) }\includegraphics[width=0.2\textwidth]{imgs/money}}
        \visible<\iftoggle{static}{1}{7-}>{\raisebox{3em}{ \(=\) } \includegraphics[width=0.2\textwidth]{imgs/sprunger}}
    \)
